    ...
    <div class="row justify-content-center">
        <div class="col-md-9 col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <!-- Título principal con color Info (azul/cian) -->
                    <h2 class="fw-bold"><i class="bi bi-person-plus-fill me-2 text-info"></i> Registrar Nuevo Trabajador</h2>
                    <p class="text-muted">Completa la información básica y de contacto para crear la cuenta del nuevo empleado.</p>
                </div>
            ...
            <div class="card shadow-lg border-0 rounded-3 p-4">
                ...
                <form action="{{ route('admin.trabajadores.store') }}" method="POST">
                    ...
                    <!-- SECCIÓN 2: DATOS DE CONTACTO (Añadidos) -->
                    ...
                    <p class="text-muted small">El trabajador deberá usar esta contraseña para su primer acceso.</p>
