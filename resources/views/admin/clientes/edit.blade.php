    ...
    <div class="row justify-content-center">
        <div class="col-md-9 col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <!-- Título dinámico y con icono de éxito (Verde para Clientes) -->
                    <h2 class="fw-bold"><i class="bi bi-people-fill me-2 text-success"></i> Editar Cliente: {{ $cliente->name }}</h2>
                    <p class="text-muted">Actualiza la información personal, de contacto o la contraseña del cliente.</p>
                </div>
                ...
                <form action="{{ route('admin.clientes.update', $cliente->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone', $cliente->phone) }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $cliente->address) }}">
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <p class="text-muted small">Solo llena estos campos si deseas establecer una nueva contraseña. Si los dejas vacíos, la contraseña actual se mantendrá.</p>
